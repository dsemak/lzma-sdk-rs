...
fn main() {
    ...
    let mut bindings = bindgen::Builder::default()
        ...
        .allowlist_function("x86_Convert")
        .allowlist_function("ARM_Convert")
        .allowlist_function("ARMT_Convert")
        .allowlist_function("PPC_Convert")
        .allowlist_function("SPARC_Convert")
        .allowlist_function("IA64_Convert")
